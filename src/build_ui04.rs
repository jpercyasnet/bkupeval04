                   ...
                   match reader.read_line(&mut line) {
                      Ok(bytes_read) => {
                          ...
                          if line.contains("<Cd>") {
                              ...
                              slevel = "Dir";
                              let stroutput = format!("test output");
...
//                          let progressfr: f64 = linenum as f64 / count as f64;
